...
Alamo mentions homeless youth but it's not being captured by the code.
It has been imported as "homeless youth"
...
Four regions used the phrase "opportunity youth" and five regions used
the phrase "disconnected youth". Greater Dallas stood out as the region
that used these phrases most often. This analysis needs to be redone with tidytext.
