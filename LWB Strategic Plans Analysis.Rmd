...
# And I need to keep in Out and In, for in school and out of school youth
...
Because "work" is seen as positive in this sentiment dataset, I removed it. In these texts I think it's mostly a neutral term.
...
bigrams_filtered <- bigrams_separated %>%
  ...
  mutate(word1 = gsub(x = word1, pattern = "[0-9],,", replacement = ""),
         word2 = gsub(x = word2, pattern = "[0-9]", replacement = ""))


# UPDATE: still need to remove unwanted punctuation
 # mutate(word = gsub(x = word, pattern = ",,", replacement = ""))
...
I think "school youth" comes from the phrases: "in school youth" and "out of school youth".
...
Opportunity Youth made Capital Area's top 15.
East Texas evangelical language is interesting.
West Central Texas mentions youth success.


I looked at trigrams as well but didn't see anything worth mentioning.
...
Note: "Disconnected" wasn't in the sentiment dataset I used, so I manually added it.
